...
object Config {
  ...
  object Relays {
    ...
    private val relays: mutable.Buffer[Relay] = relaysConf.asScala.map(c => Relay(new String((c.getString("irc_channel")).getBytes("ISO-2022-JP"), "ISO-2022-JP"), c.getString("slack_channel")))
